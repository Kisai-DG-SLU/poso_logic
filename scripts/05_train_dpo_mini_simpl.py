"""
Entraînement DPO simplifié avec un patch minimal qui contourne les problèmes
de compatibilité TRL/transformers
"""
import sys, os
...
patch_module = SourceFileLoader("monkey_patch_direct_final2", 
                                "/mnt/prod/scripts/monkey_patch_direct_final2.py").load_module()
...
def get_dpo_config():
    ...
    return {
        ...
        "save_total_limit": 1,
        "warmup_steps": 5,
        "max_samples": 50,  # Limiter le nombre d'exemples
...
def train_dpo():
    ...
    # Entraînement avec notre boucle patchée
    print("\n=== DÉBUT ENTRAÎNEMENT DPO ===")
    try:
        # Notre version patchée de train() sera utilisée grâce au monkey patching
...
def main():
    ...
    print("\n✅ TEST DPO MINI RÉUSSI! Prêt pour l'entraînement complet.")
