"""
Script d'entraînement DPO production avec réduction mémoire - implémentation personnalisée
...
def get_dpo_config():
    ...
    return {
        ...
        "max_seq_length": 512,  # Réduit pour économiser la mémoire
        "batch_size": 1,
        "gradient_accumulation_steps": 32,  # Augmenté pour économiser la mémoire
        "learning_rate": 1e-5,
        "num_train_epochs": 1,
        ...
        "warmup_steps": 100,
        "save_total_limit": 2,
        "eval_size": 500,           # Réduit pour économiser la mémoire
        "max_steps": 5000,           # Limiter le nombre de steps pour avoir un résultat
...
def train_dpo():
    ...
    if processed_dir.exists():
        ...
        train_dataloader = DataLoader(
            ...
            num_workers=1, pin_memory=False  # Pin memory False pour économiser de la mémoire
        )
