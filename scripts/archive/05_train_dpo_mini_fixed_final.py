...
et un patch amélioré pour résoudre l'incompatibilité TRL/transformers
"""
import sys, os
...
patch_module = SourceFileLoader("monkey_patch_direct_v2", 
                                "/mnt/prod/scripts/monkey_patch_direct_v2.py").load_module()
...
def train_dpo():
    ...
    training_args = TrainingArguments(
        ...
        # En transformers 4.51.0, c'est "eval_strategy", pas "evaluation_strategy"
        eval_strategy="steps",  
        save_strategy="steps",
        ...
        max_steps=10,  # Limiter à 10 steps max
    )
